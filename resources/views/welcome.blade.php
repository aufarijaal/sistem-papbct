...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div id="app">
            <div class="bg-white welcome-wrapper w-full h-full flex flex-col lg:justify-center items-center text-center gap-7 pt-20 lg:gap-10">
                <img class="egg" src="{{ asset('icons/icon-72x72.png') }}" alt="">
                <h1 class="web-title text-xl lg:text-5xl flex flex-col lg:gap-3 text-slate-900" style="font-weight: 900;">
                  <span>Sistem Kontrol dan Monitoring</span>
                  <span>Prototype Alat Pembuat Bubuk Cangkang Telur</span>
                </h1>
